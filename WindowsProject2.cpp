                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringA(hInstance, IDC_WINDOWSPROJECT2, szWindowClass, MAX_LOADSTRING);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowA(szWindowClass, (const char*)L"Windows Project", WS_OVERLAPPEDWINDOW,
